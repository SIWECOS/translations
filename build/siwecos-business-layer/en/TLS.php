...
return [
  ...
  */
  ...
  'CERTIFICATE_NOT_SENT_BY_SERVER_SOLUTION_TIPS' => "<p>Urgently update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS implementation</a>. Current software no longer allows this type of configuration. </p>",
  ...
  'CIPHERSUITEORDER_ENFORCED_SOLUTION_TIPS' => "<p>Configure your web server so that the web server selects the encryption method that is used for communication between your website and the visitor's web browser. </p>",
  ...
  'CIPHERSUITE_DES_SOLUTION_TIPS' => "<p>Deactivate support for the DES encryption method in your web server software. </p>",
  ...
  'CIPHERSUITE_EXPORT_SOLUTION_TIPS' => "<p>Deactivate support for EXPORT encryption methods on the web server. </p>",
  ...
  'CIPHERSUITE_NULL_SOLUTION_TIPS' => "<p>Deactivate support for NULL encryption methods. </p>",
  ...
  'CIPHERSUITE_RC4_SOLUTION_TIPS' => "<p>Deactivate support for the <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/RC4\">RC4</a> encryption method. </p>",
  ...
  'CRIME_VULNERABLE_POSITIVE'      => "Not vulnerable to <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external autonumber\" href=\"https://en.wikipedia.org/wiki/CRIME\">[1]</a>",
  'CRIME_VULNERABLE_NEGATIVE'      => "Vulnerable to <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external autonumber\" href=\"https://en.wikipedia.org/wiki/CRIME\">[1]</a>",
  'CRIME_VULNERABLE_DESCRIPTION'   => "<p>The server is vulnerable to [<a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external autonumber\" href=\"https://en.wikipedia.org/wiki/CRIME\">[1]</a>]. This allows an attacker to decode the communication. </p>",
  'CRIME_VULNERABLE_SOLUTION_TIPS' => "<p><a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external autonumber\" href=\"https://en.wikipedia.org/wiki/CRIME\">[1]</a> can be defeated by preventing the use of compression. Either on the client side, if the browser disables the compression of SPDY requests, or if the web page prevents the use of data compression for such transactions using the protocol negotiation characteristics of the <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> protocol. Deactivate TLS compression on your server. </p>",
  ...
  'HEARTBLEED_VULNERABLE_POSITIVE'      => "Not vulnerable to Heartbleed",
  'HEARTBLEED_VULNERABLE_NEGATIVE'      => "Vulnerable to Heartbleed",
  'HEARTBLEED_VULNERABLE_DESCRIPTION'   => "<p>The server is vulnerable to a Heartbleed attack. As a result, an attacker could read sensitive data from the server's working memory, such as private keys and customer data. </p>",
  'HEARTBLEED_VULNERABLE_SOLUTION_TIPS' => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately. </p>",
  ...
  'HTTPS_NOT_SUPPORTED_SOLUTION_TIPS' => "<p>Activate <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> (Transport Layer Security) </p>",
  ...
  'HTTPS_NO_RESPONSE_SOLUTION_TIPS' => "<p>Please check your input for typing errors. </p>",
  ...
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_POSITIVE'      => "Not vulnerable to Ephemeral Invalid Curve attacks.",
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_NEGATIVE'      => "Vulnerable by Ephemeral Invalid Curve attacks.",
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_DESCRIPTION'   => "<p>The server is vulnerable to an <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://www.golem.de/news/verschluesselung-punkte-auf-der-falschen-ellipt\">ischen-kurve-1511-117643.html Ephemeral Invalid Curve Angriff</a>. This allows an attacker to attack connections. </p>",
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_SOLUTION_TIPS' => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately. </p>",
  ...
  'INVALID_CURVE_VULNERABLE_POSITIVE'      => "Not vulnerable to Invalid Curve attacks.",
  'INVALID_CURVE_VULNERABLE_NEGATIVE'      => "Vulnerable to Invalid Curve attacks.",
  'INVALID_CURVE_VULNERABLE_DESCRIPTION'   => "<p>The server is vulnerable to an Invalid Curve attack. This allows an attacker to steal the private key of your <a target=\"siwecos_wiki\" href=\"https://siwecos.de/wiki/Certificate\" title=\"Certificate\">certificate</a>. </p>",
  'INVALID_CURVE_VULNERABLE_SOLUTION_TIPS' => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately. </p>",
  ...
  'PADDING_ORACLE_VULNERABLE_POSITIVE'      => "Not vulnerable to <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Padding_oracle_attack\">Padding Oracle attacks</a>.",
  'PADDING_ORACLE_VULNERABLE_NEGATIVE'      => "Vulnerable to <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Padding_oracle_attack\">Padding Oracle attacks</a>.",
  ...
  'PADDING_ORACLE_VULNERABLE_SOLUTION_TIPS' => "<p>Update your <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately. </p>",
  ...
  'POODLE_VULNERABLE_DESCRIPTION'   => "<p>The server is vulnerable to a <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/POODLE\">POODLE attack</a>, which allows an attacker to decrypt the communication. </p>",
  'POODLE_VULNERABLE_SOLUTION_TIPS' => "<p>Deactivate the outdated encryption protocol SSL3 on your server immediately! </p>",
  ...
  'PROTOCOLVERSION_SSL2_SOLUTION_TIPS' => "<p><a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS encoding</a> is considered to be the standard today. Therefore you should not use SSL2. </p>",
  ...
  'PROTOCOLVERSION_SSL3_SOLUTION_TIPS' => "<p><a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> encoding is considered to be the standard today. Therefore you should not use SSL3. </p>",
  ...
  'TLS_POODLE_VULNERABLE_SOLUTION_TIPS' => "<p>Update the <a target=\"siwecos_extern\" rel=\"nofollow\" class=\"external text\" href=\"https://en.wikipedia.org/wiki/Transport_Layer_Security\">TLS</a> implementation on your server immediately. In the Apache configuration, you can specify the line \"SSLProtocol All -SSLv2 -SSLv3 \". </p>",
