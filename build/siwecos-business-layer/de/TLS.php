...
return [
  ...
  */
  ...
  'CERTIFICATE_EXPIRED_SOLUTION_TIPS' => '<p>Wenn <i>Zertifikat abgelaufen</i> gemeldet wurde, erneuern Sie das eingesetzte <a target="siwecos_wiki" href="https://siwecos.de/wiki/Zertifikate" title="Zertifikate">Zertifikat</a>. Wie Sie Zertifikate verlängern können, lesen Sie hier: <a target="siwecos_wiki" href="https://siwecos.de/wiki/Zertifikate#Was_tun.2C_wenn_ein_SSL-Zertifikat_abgelaufen_ist.3F" title="Zertifikate">Zertifikat abgelaufen</a>.  </p>',
  ...
  'CERTIFICATE_NOT_SENT_BY_SERVER_SOLUTION_TIPS' => '<p>Wenn <i>Server sendet kein Zertifikat</i> gemeldet wurde, aktualisieren Sie dringend die von Ihnen eingesetzte <a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">TLS-Implementierung</a>. Moderne Software erlaubt diese Art der Konfiguration nicht mehr. </p>',
  ...
  'CIPHERSUITEORDER_ENFORCED_SOLUTION_TIPS' => '<p>Wenn <i>Verantwortungslose Auswahl der Client-Verschlüsselungsmethoden</i> gemeldet wurde, konfigurieren Sie Ihren Webserver so, dass Ihr Webserver die <a target="siwecos_wiki" href="https://siwecos.de/wiki/Verschl%C3%BCsselungsmethodik" title="Verschlüsselungsmethodik">Verschlüsselungsmethodik</a> bei der Kommunikation zwischen Ihrer Webseite und dem Webbrowser des Besuchers bestimmt. </p>',
  ...
  'CIPHERSUITE_DES_SOLUTION_TIPS' => '<p>Wenn <i>Veraltete DES Verschlüsselungsmethodik unterstützt</i> gemeldet wurde, deaktivieren Sie die Unterstützung der DES <a target="siwecos_wiki" href="https://siwecos.de/wiki/Verschl%C3%BCsselungsmethodik" title="Verschlüsselungsmethodik">Verschlüsselungsmethodik</a> in Ihrer Webserver-Software. </p>',
  ...
  'CIPHERSUITE_EXPORT_SOLUTION_TIPS' => '<p>Wenn <i>Schwache Export Verschlüsselung unterstützt</i> gemeldet wird, deaktivieren Sie die Unterstützung von EXPORT <a target="siwecos_wiki" href="https://siwecos.de/wiki/Verschl%C3%BCsselungsmethodik" title="Verschlüsselungsmethodik">Verschlüsselungsmethoden</a> im Webserver. </p>',
  ...
  'CIPHERSUITE_NULL_SOLUTION_TIPS' => '<p>Wenn <i>Unsichere NULL Chiffren unterstützt</i> gemeldet wurde, deaktivieren Sie die Unterstützung von NULL <a target="siwecos_wiki" href="https://siwecos.de/wiki/Verschl%C3%BCsselungsmethodik" title="Verschlüsselungsmethodik">Verschlüsselungsmethoden</a>. </p>',
  ...
  'CIPHERSUITE_RC4_SOLUTION_TIPS' => '<p>Wenn <i>Veraltete RC4 Verschlüsselungsmethodik unterstützt</i> gemeldet wird, deaktivieren Sie die Unterstützung der <a target="siwecos_wiki" href="https://siwecos.de/wiki/RC4_Verschl%C3%BCsselungsmethodik" title="RC4 Verschlüsselungsmethodik">RC4 Verschlüsselungsmethodik</a>. </p>',
  ...
  'CRIME_VULNERABLE_POSITIVE'      => 'Nicht verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Crime-Schwachstelle/DE" title="Crime-Schwachstelle/DE">CRIME</a>',
  'CRIME_VULNERABLE_NEGATIVE'      => 'Verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Crime-Schwachstelle/DE" title="Crime-Schwachstelle/DE">CRIME</a>',
  'CRIME_VULNERABLE_DESCRIPTION'   => '<p>Der Server ist verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Crime-Schwachstelle/DE" title="Crime-Schwachstelle/DE">CRIME</a>. Eine Schwachstelle, welche es einem Angreifer erlaubt, die Kommunikation zu entschlüsseln. </p>',
  'CRIME_VULNERABLE_SOLUTION_TIPS' => '<p>CRIME Verwundbarkeit kann besiegt werden, indem die Verwendung von Komprimierung verhindert wird. Entweder auf der Client-Seite, indem der <a target="siwecos_wiki" href="https://siwecos.de/wiki/Browser" title="Browser">Browser</a> die Komprimierung von SPDY-Anfragen deaktiviert, oder indem die Webseite die Verwendung von Datenkompression bei solchen Transaktionen unter Verwendung der Protokollaushandlungsmerkmale des TLS-Protokolls verhindert. Deaktivieren sie <a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">TLS-Compression</a> auf Ihrem Server. </p>',
  ...
  'HEARTBLEED_VULNERABLE_POSITIVE'      => 'Nicht verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Heartbleed-Schwachstelle/DE" title="Heartbleed-Schwachstelle/DE">Heartbleed</a>',
  'HEARTBLEED_VULNERABLE_NEGATIVE'      => 'Verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Heartbleed-Schwachstelle/DE" title="Heartbleed-Schwachstelle/DE">Heartbleed</a>',
  'HEARTBLEED_VULNERABLE_DESCRIPTION'   => '<p>Der Server ist verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Heartbleed-Schwachstelle/DE" title="Heartbleed-Schwachstelle/DE">Heartbleed</a>. Dadurch kann ein Angreifer sensible Daten aus dem Arbeitsspeicher des Servers auslesen, wie z. B. geheime Schlüssel und Kundendaten. </p>',
  'HEARTBLEED_VULNERABLE_SOLUTION_TIPS' => '<p>Bei Verwundbarkeit spielen Sie umgehend ein Update für Ihre <a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">TLS-Implementierung</a> auf Ihrem <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ein. </p>',
  ...
  'HTTPS_NOT_SUPPORTED_SOLUTION_TIPS' => '<p>Wenn <i>Server scheint kein TLS zu unterstützen</i> gemeldet wird, aktivieren Sie TLS (<a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">Transportschichtsicherheit</a>). </p>',
  ...
  'HTTPS_NO_RESPONSE_SOLUTION_TIPS' => '<p>Wenn der Server nicht antwortet, überprüfen Sie bitte Ihre Eingabe auf Eingabefehler. </p>',
  ...
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_POSITIVE'      => 'Nicht verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Invalid-Curve-Ephemeral-Schwachstelle/DE" title="Invalid-Curve-Ephemeral-Schwachstelle/DE">Ephemeral Invalid Curve Angriff</a> Angriffe.',
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_NEGATIVE'      => 'Verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Invalid-Curve-Ephemeral-Schwachstelle/DE" title="Invalid-Curve-Ephemeral-Schwachstelle/DE">Ephemeral Invalid Curve Angriff</a> Angriffe.',
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_DESCRIPTION'   => '<p>Der <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ist verwundbar durch einen <a target="siwecos_wiki" href="https://siwecos.de/wiki/Invalid-Curve-Ephemeral-Schwachstelle/DE" title="Invalid-Curve-Ephemeral-Schwachstelle/DE">Ephemeral Invalid Curve Angriff</a>. Dadurch kann ein Angreifer die Verbindungen angreifen. </p>',
  'INVALID_CURVE_EPHEMERAL_VULNERABLE_SOLUTION_TIPS' => '<p>Wenn Verwundbarkeit gemeldet wurde, spielen Sie umgehend ein Update für Ihre <a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">TLS-Implementierung</a> auf Ihrem <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ein. </p>',
  ...
  'INVALID_CURVE_VULNERABLE_POSITIVE'      => 'Nicht verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Invalid-Curve-Schwachstelle/DE" title="Invalid-Curve-Schwachstelle/DE">Invalid Curve Angriffe</a>.',
  'INVALID_CURVE_VULNERABLE_NEGATIVE'      => 'Verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Invalid-Curve-Schwachstelle/DE" title="Invalid-Curve-Schwachstelle/DE">Invalid Curve Angriffe</a>.',
  'INVALID_CURVE_VULNERABLE_DESCRIPTION'   => '<p>Der <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ist verwundbar durch einen <a target="siwecos_wiki" href="https://siwecos.de/wiki/Invalid-Curve-Schwachstelle/DE" title="Invalid-Curve-Schwachstelle/DE">Invalid Curve Angriff</a>. Dadurch kann ein Angreifer den geheimen Schlüssel Ihres <a target="siwecos_wiki" href="https://siwecos.de/wiki/Zertifikate" title="Zertifikate">Zertifikats</a> stehlen. </p>',
  'INVALID_CURVE_VULNERABLE_SOLUTION_TIPS' => '<p>Wenn Verwundbarkeit gemeldet wurde, spielen Sie umgehend ein Update für Ihre <a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">TLS-Implementierung</a> auf Ihrem <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ein. </p>',
  ...
  'PADDING_ORACLE_VULNERABLE_POSITIVE'      => 'Nicht verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/PADDING-ORACLE-Schwachstelle/DE" title="PADDING-ORACLE-Schwachstelle/DE">Padding-Oracle Angriffe</a>.',
  'PADDING_ORACLE_VULNERABLE_NEGATIVE'      => 'Verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/PADDING-ORACLE-Schwachstelle/DE" title="PADDING-ORACLE-Schwachstelle/DE">Padding Oracle Angriffe</a>.',
  ...
  'PADDING_ORACLE_VULNERABLE_SOLUTION_TIPS' => '<p>Wenn Verwundbarkeit gemeldet wurde, spielen Sie umgehend ein Update für Ihre <a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">TLS Implementierung</a> auf Ihrem <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ein. </p>',
  ...
  'POODLE_VULNERABLE_DESCRIPTION'   => '<p>Der <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ist verwundbar durch einen <a target="siwecos_wiki" href="https://siwecos.de/wiki/POODLE-Schwachstelle/DE" title="POODLE-Schwachstelle/DE">POODLE-Angriff</a>, welcher es einem Angreifer erlaubt, die Kommunikation zu entschlüsseln. </p>',
  'POODLE_VULNERABLE_SOLUTION_TIPS' => '<p>Wenn Verwundbarkeit gemeldet wurde, deaktivieren Sie umgehend das veraltete Verschlüsselungsprotokoll <a target="siwecos_wiki" href="https://siwecos.de/wiki/SSL" title="SSL">SSL3</a> auf Ihrem Server! </p>',
  ...
  'SWEET32_VULNERABLE_DESCRIPTION'   => '<p>Der <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ist verwundbar durch <a target="siwecos_wiki" href="https://siwecos.de/wiki/Sweet32-Schwachstelle/DE" title="Sweet32-Schwachstelle/DE">Sweet32</a>, welche es einem Angreifer erlaubt, Teile der Kommunikation zu entschlüsseln, falls über eine Verbindung große Mengen Daten transferiert werden. </p>',
  ...
  'TLS_POODLE_VULNERABLE_SOLUTION_TIPS' => '<p>Wenn Verwundbarkeit gemeldet wurde, spielen Sie umgehend ein Update für Ihre <a target="siwecos_wiki" href="https://siwecos.de/wiki/Transport_Layer_Security" title="Transport Layer Security">TLS-Implementierung</a> auf Ihrem <a target="siwecos_wiki" href="https://siwecos.de/wiki/Server" title="Server">Server</a> ein. In der Apache-Konfiguration kann man etwa die Zeile "SSLProtocol All -SSLv2 -SSLv3" angeben. </p>',
